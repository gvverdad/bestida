...
.invalid\\:\\[\\&\\:not\\(\\:-moz-placeholder-shown\\)\\:not\\(\\:focus\\)\\]\\:border-error:not(:-moz-placeholder-shown):not(:focus):invalid {
  --tw-border-opacity: 1;
  border-color: hsl(var(--er) / var(--tw-border-opacity));
}

.invalid\\:\\[\\&\\:not\\(\\:placeholder-shown\\)\\:not\\(\\:focus\\)\\]\\:border-error:not(:placeholder-shown):not(:focus):invalid {
  --tw-border-opacity: 1;
  border-color: hsl(var(--er) / var(--tw-border-opacity));
}

.\\[\\&\\>div\\.flatpickr-month\\]\\:-translate-y-3>div.flatpickr-month {
  --tw-translate-y: -0.75rem;
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}

.\\[\\&_span\\.flatpickr-day\\.selected\\]\\:\\!border-gray-900 span.flatpickr-day.selected {
  --tw-border-opacity: 1 !important;
  border-color: rgb(17 24 39 / var(--tw-border-opacity)) !important;
}

.\\[\\&_span\\.flatpickr-day\\.selected\\]\\:\\!bg-gray-900 span.flatpickr-day.selected {
  --tw-bg-opacity: 1 !important;
  background-color: rgb(17 24 39 / var(--tw-bg-opacity)) !important;
}

.\\[\\&_span\\.flatpickr-day\\]\\:\\!rounded-md span.flatpickr-day {
