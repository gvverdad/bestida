...
# run "./shellserver src.shell.loadappmenu2 development.ini" in /home/gvv/Projects/bestida
...
def run(app):
    ...
    with open("data/appmenu.json", "r") as f:
        appmenu = json.load(f)

    create_menu(session, appmenu["Mainmenu"], main_menu)
