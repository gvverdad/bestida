...
from src.db.scripts.appmenu import appmenujson

# run "./shellserver src.shell.loadappmenu development.ini" in /home/gvv/Projects/bestida
...
def run(app):
    ...
    create_menu(session, appmenujson["Mainmenu"], main_menu)
