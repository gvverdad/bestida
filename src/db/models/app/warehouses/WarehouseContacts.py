...
class WarehouseContact(Person):
    ...
    __table_args__ = dict(info=dict(label="Warehouse Contacts",
                                    desc="Contacts",
...
Index("WarehouseContact_Index1", WarehouseContact.ItemWarehouse_Id,
      WarehouseContact.Type_Id, unique=True)
