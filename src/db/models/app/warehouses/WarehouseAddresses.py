...
class WarehouseAddress(Address):
    ...
    __table_args__ = dict(info=dict(label="Warehouse Addresses",
                                    desc="Addresses",
                                    parentTables=[
...
Index("WarehouseAddress_Index1", WarehouseAddress.ItemWarehouse_Id,
      WarehouseAddress.Type_Id, unique=True)
