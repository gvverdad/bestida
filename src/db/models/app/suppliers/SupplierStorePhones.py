...
class SupplierStorePhone(Phone):
    ...
    __table_args__ = dict(info=dict(label="Supplier Store Phones",
                                    desc="Phones",
                                    parentTables=[
...
Index("SupplierStorePhone_Index1", SupplierStorePhone.ItemSupplierStore_Id,
      SupplierStorePhone.Type_Id, unique=True)
