...
class ProductType(Model):
    ...
    __table_args__ = dict(info=dict(label="Product Types",
    ...
    Company = relationship("Company", primaryjoin="Company.Id==ProductType.Company_Id")
    ...
    CreateOpId = relationship("User", primaryjoin="User.Id==ProductType.CreateOpId_Id")
    ...
    ModifiedOpId = relationship("User", primaryjoin="User.Id==ProductType.ModifiedOpId_Id")
    ...
    ContractPrices = relationship("ContractPriceDiscount", uselist=False,
                               back_populates="Type",
                               primaryjoin="ContractPriceDiscount.Type_Id==ProductType.Id",
                               info=dict(hidden=True, dump=False))
...
Index("ProductType_Index1", ProductType.Company_Id, ProductType.Type, unique=True)
